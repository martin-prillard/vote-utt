...
//REQUETES SQL
$SELECT_ALL_CURRENT_ELECTION = "SELECT election_id, election_label, election_time_start, election_time_end FROM election WHERE election_time_end > ? ORDER BY election_time_end DESC";
...
$resultats = $db->prepare($SELECT_ALL_CURRENT_ELECTION);
